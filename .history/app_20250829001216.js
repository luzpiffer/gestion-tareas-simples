...
// Paleta de colores pastel para las tarjetas
const coloresPastel = [
    '#FFC0CB', // Rosa
    '#B0E0E6', // Azul claro
    '#98FB98', // Verde menta
...
function mostrarTareas(tareas) {
    ...
    tareas.forEach(t => {
        ...
        // Elegir un color pastel al azar de la paleta
        const colorAlAzar = coloresPastel[Math.floor(Math.random() * coloresPastel.length)];
        tareaDiv.style.backgroundColor = colorAlAzar; // Asigna el color de fondo
