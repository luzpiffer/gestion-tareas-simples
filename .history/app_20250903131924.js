...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Código existente para el manejo de la fecha mínima, etc.
    const fechaInput = document.querySelector("#formTarea input[name='fecha_vencimiento']");
    if (fechaInput) {
...
function mostrarTareas(tareas) {
    ...
    div.innerHTML = "";
    if (tareas.length === 0) { div.innerHTML = "<p>No hay tareas.</p>"; return; }
    tareas.forEach(t => {
