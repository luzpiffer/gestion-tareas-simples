...
document.getElementById("registroForm").addEventListener("submit", async e => {
    e.preventDefault();
    const username = document.getElementById("regUsername").value; // ✅ CORREGIDO
    const password = document.getElementById("regPassword").value; // ✅ CORREGIDO
...
function mostrarTareas(tareas) {
    ...
    div.innerHTML = "";
    if (tareas.length === 0) {
qdiv.innerHTML = "<p>No hay tareas.</p>";
        return;
    }
    tareas.forEach(t => {
